...
antechamber -i dihydroxypro.pdb -fi pdb -o dihydroxypro.ac -fo ac -c bcc -at amber
antechamber -i trans3pro.pdb    -fi pdb -o trans3pro.ac    -fo ac -c bcc -at amber
rm sqm*
rm ANTECHAMBER*
rm ATOMTYPE.INF
...
prepgen -i trans3pro.ac    -o trans3pro.prepin    -m trans3pro.mc    -rn PR3
